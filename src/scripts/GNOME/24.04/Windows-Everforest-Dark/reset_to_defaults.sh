...
# Begin Windows Everforest Dark Theme Removal
echo "Continue script execution in Windows Everforest Dark Theme Removal at $(date)" >> "$LOG_FILE"
...
if check_internet; then
    ...
    log_message "INFO" "Removing Everforest Dark Theme Pack"
    printc "YELLOW" "-> Removing Everforest Dark Theme Pack..."
    rm -rf ${HOME}/.themes/Everforest-*

    log_message "INFO" "Removing Everforest Dark Icons Pack"
    printc "YELLOW" "-> Removing Everforest Dark Icons Pack..."
    ...
    if whiptail --title "Windows Everforest Dark Theme Removal" --yesno "Windows Everforest Dark Theme has been removed successfully.\nDo you want to sign out to fully reset ?" 10 60; then
...
# End Windows Everforest Dark Theme Removal