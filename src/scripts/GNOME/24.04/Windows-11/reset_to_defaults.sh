...
echo "Continue script execution in Windows 11 Removal at $(date)" >> "$LOG_FILE"
...
if check_internet; then
    ...
    rm -rf ${HOME}/.themes/Win11-* ${HOME}/.local/share/icons/Win11-* || handle_error "Failed to Remove Themes and Icons Pack"
    clear
